...
## 1. Introduction
  ...
  A smaller metal [Boop](https://github.com/PrintersForAnts/Boop).
...
- Using a wide mgn7 rail instead of mgn9 - rigidity is on par with MGN12C while taking 1mm less space in Y direction.
...
* What else besides the BOM do I need?
...
* I would like to sell manufactured metal parts. Can I do that free of charge or do I have to ask your permission or pay for license, royalties, etc?
